...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<com.example.benwong.myapplication.backend.myApi.model.MyJoke> {
     ...
     */
    protected SayHi() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.benwong.myapplication.backend.myApi.model.MyJoke.class);
    }
